...
<div class="apply" align="center">
	<br>
	<h1 align="center">Process Successfully!</h1>
	<br />
	<input id="return" class="submit" type="button" name="return" value="Return" onclick="location='/ta/application/Teacher/viewunprocessed'"/>
</div>
</body>
</html>
