...
<div class="box">
	...
	<div class="img"><a href="/newsletter/view/148"><img width="720" src="/ji_upload/page/page20151231133825.jpg"/></a>
	</div>
	...
	<div class="team none">
		...
		<ul>
			<a href="#">
				<li><img src="/ji_upload/newsletter/1224-01.jpg"/><span>Dengpan Huang</span><i>IT Engneer</i></li>
			</a>
			<a href="#">
				<li><img src="/ji_upload/newsletter/1224-01.jpg"/><span>Dengpan Huang</span><i>IT Engneer</i></li>
			</a>
...
<div class="box">
	<div class="au mt20">
		<div class="left">
			<h2>Announcement</h2>
			<li><h3><?= $announcement['page_title'] ?></h3><span><?= $announcement['page_summary'] ?></span><a
						href="/newsletter/view/<?= $announcement['id'] ?>"><p class="readmore">Read More</p></a></li>
...
<div class="box">
	...
	<div class="story pt30">
		...
		{ ?>
			<li class="mb20"><img src="/ji_upload/page/<?= $s->page_pic ?>"/>
				<p>
					<strong><?= $s->page_title ?></strong><span><?= $s->page_summary ?></span><i><?= $s->page_keywords ?></i><a
							href="/newsletter/view/<?= $s->id ?>"><span class="readmore">Read More</span></a></p></li>
		<?php } ?>
...
<div class="box">
	...
	<div class="img"><a href="/newsletter/view/155"><img width="720" src="/ji_upload/page/page20151231133611.jpg"/></a>
	</div>
</div>
<div class="box">
	...
	<div class="share">
		...
		{ ?>
			<li><img src="/ji_upload/page/<?= $s->page_pic ?>"/>
				<h3><?= $s->page_title ?></h3>
				<p><?= $s->page_summary ?></p><a href="/newsletter/view/<?= $s->id ?>"><span
							class="readmore">Read More</span></a></li>
		<?php } ?>
	</div>
	<div class="clear"></div>
</div>
<div class="box">
	...
	<div class="gallery">
		...
		{ ?>
			<li><img src="/ji_upload/page/<?= $g->page_pic ?>"/>
				<p><?= $g->page_summary ?><a href="/newsletter/view/<?= $g->id ?>"><span
								class="readmore">Read More</span></a></p>
				<P><STRONG style="font-size:22px; font-weight:normal; line-height:40px;">Submit a news
						story</STRONG><BR/>
					If you have an idea for a news story that you would like to submit to JI E-newsletter, please email:<br/>
					<a href="mailto:ji-newsletter@sjtu.edu.cn">ji-newsletter@sjtu.edu.cn</a> .<BR/>
