		...
		<?php foreach($list as $item): ?>
			<fieldset class="text-container">
				...
				<ul id="personal-information">
					...
					<li>Course ID: <input class="readonly" name="courseid" value="<?php echo $courseid;?>" style="font-size:18px;" size="5" readonly></li>
					...
					<li class="last">Email: <input name="email" style="font-size:18px;" size="20" value="<?php echo set_value('email'); ?>">
			...
			<fieldset class="text-container-2">
				...
				<textarea class="text" name="introduction" rows="15"><?php echo set_value('introduction'); ?></textarea>
				<?php echo form_error('introduction','<span>','</span>')?>
			</fieldset>

			<fieldset class="text-container-2">
				<legend>Comment</legend>
				<textarea class="text" name="comment" rows="8"><?php echo set_value('comment'); ?></textarea>
				<?php echo form_error('comment','<span>','</span>')?>
			</fieldset>
		<?php endforeach;?>
        <input id="submit" name="submit" type="submit" align="center" value="Submit" class="btn-default">
    </form>
</div>
</body>
</html>