...
<div class="box" sroll="no">
	...
	<div id="left">
		...
		<div class="time"><span id="left-min">00</span><span>:</span><span id="left-sec">00</span></div>
		<div class="button"><span id="left-start">start</span><span id="left-stop">stop</span></div>
	</div>
	
	<div id="right">
		<input value="" placeholder='Team B' type="text"/>
		<div class="time"><span id="right-min">00</span><span>:</span><span id="right-sec">00</span></div>
		<div class="button"><span id="right-start">start</span><span id="right-stop">stop</span></div>
	</div>
...
<script>
	...
	;
	$('#left-start').click(function ()
	                       {
		                       left_up();
	                       });
	$('#left-stop').click(function ()
	                      {
		                      clearTimeout(left_action);
	                      })
...
<script>
	...
	;
	$('#right-start').click(function ()
	                        {
		                        right_up();
	                        });
	$('#right-stop').click(function ()
	                       {
		                       clearTimeout(right_action);
	                       })
