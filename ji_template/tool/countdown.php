...
<div class="box" sroll="no">
	...
	<div id="left"><input value="" placeholder='Time(Minute)' id="time" type="text"/>
		<div class="time"><span id="left-min">00</span><span>:</span><span id="left-sec">00</span><span>:</span><span
					id="left-ms">00</span></div>
		<div class="button"><span id="start">start</span><span id="stop">stop</span></div>
	</div>
</div>
...
<script>
	...
	{ //加时函数
		if (globletime > 0)
		{ //如果不到5分钟eval(document.getElementById('time')).value
			--globletime; //时间变量自增1
			if ($("#left-min").text() < 10)
			{
