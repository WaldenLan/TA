...
<div class="main">
	<div class="title"><h1>Course Equivalencies</h1>
	...
	<div class="universities">
		...
		<?php foreach ($universities as $u): ?>
			<a href="/equivalence/university/index/<?= $u->university_id; ?>">
				<li><span class="left"><?php if ($u->university_top == 1)
						{ ?><img style="top:3px; position:relative;"
						         src="/ji_style/image/top.gif"/><?php } ?><?= $u->university_name; ?></span><span
							class="right"><?= $u->university_country; ?> / <?= $u->university_city; ?></span></li>
			</a>
		<?php endforeach; ?>
	</div>
</div>
