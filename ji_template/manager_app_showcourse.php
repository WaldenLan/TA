	...
	<tr>
		<?php foreach ($list as $item): ?>
			...
			<td><input type="button" name="modify" value="修改"
			           onclick="location='Edit/editcourse<?php echo "?obj=ta_recruitment_start" ?>'"/></td>
			<td><input type="button" name="start" value="开放申请"
			           onclick="location='/Edit/editcourse<?php echo "?obj=ta_recruitment_start" ?>'"/></td>
			<td><input type="button" name="close" value="关闭申请"
			           onclick="location='/Edit/editcourse<?php echo "?obj=ta_recruitment_start" ?>'"/></td>
		<?php endforeach; ?>
	</tr>
</table>
