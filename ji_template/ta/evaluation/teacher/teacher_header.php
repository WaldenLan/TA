...
<ul class="nav nav-pills nav-justified">
	...
	<li class="<?php echo $banner_id != 2 ? 'non-' : ''; ?>active"><a href="/ta/evaluation/teacher/evaluation">Evaluation
			Setup</a></li>
	<li class="<?php echo $banner_id != 3 ? 'non-' : ''; ?>active"><a href="/ta/evaluation/teacher/feedback/view">Feedbacks
			Process</a></li>
	<li class="<?php echo $banner_id != 4 ? 'non-' : ''; ?>active"><a href="/ta/evaluation/teacher/report">TA Report</a>
	</li>
</ul>
<div class="banner">
	<div>
