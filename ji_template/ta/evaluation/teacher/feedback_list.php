    ...
    <div class='body'>
        <div class="maincontent">
            <div class="announcement">
                <h2>View&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary <?php echo $state_id==2?'btn active':'';?>" href="/ta/evaluation/teacher/feedback/view/2">Applying</a>&nbsp;&nbsp;
                <a class="btn btn-primary <?php echo $state_id==3?'btn active':'';?>" href="/ta/evaluation/teacher/feedback/view/3">Disposed</a></h2>
