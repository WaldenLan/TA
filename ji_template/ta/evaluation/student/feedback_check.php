<?php include parent_dir(__FILE__) . '/common_header.php'; ?>
	...
	<div class='body'>
		<div class="maincontent">
			<div class="announcement">
				<h2><a class="navig"
				       href="/ta/evaluation/student/feedback/view/<?php echo $page_id; ?>">View</a>
				...
				<!--                <h5 href="/ta/evaluation/student/feedback/check/-->
				<?php //echo $feedback->id?><!--">-->
				<?php //echo $feedback->CREATE_TIMESTAMP;?><!--</h5>-->
				<p>Reply:</p>
				...
				<?php if ($feedback->state == 1): ?>
					<ul class="list-group">
						...
						<li class="list-group-item">
							...
							<h5 class="submit_time">Reply
								Time: <?php echo $manage_reply->CREATE_TIMESTAMP; ?></h5>
						</li>
					</ul>
				<?php endif ?>
				<?php if ($feedback->state == 3): ?>
					<ul class="list-group">
						...
						<li class="list-group-item">
							...
							<h5 class="submit_time">Reply
								Time: <?php echo $teacher_reply->CREATE_TIMESTAMP; ?></h5>
						</li>
					</ul>
				<?php endif ?>
				<?php if ($feedback->is_student()): ?>
...
<?php include parent_dir(__FILE__) . 'common_footer.php'; ?>