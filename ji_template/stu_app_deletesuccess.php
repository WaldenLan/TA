...
<div class="apply" align="center">
	<br>
	<h1 align="center">Delete Successfully!</h1>
	<br />
	<input id="return" class="submit" type="button" name="return" value="Return" onclick="location='/ta/application/Student/myapplication'"/>
</div>
</body>
</html>
