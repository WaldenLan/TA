...
{//登录成功后
	...
	{
		$check = $this->db->query("select * from ji_student where user_id='" . $_SESSION['jaccount']['id'] . "'")
		                  ->result();
		if (!empty($check))
		{
	...
	<div class="form">
		<form action="save" method="post">
			<b>Set a Password</b>
			<input name="student_id" placeholder="Student ID" readonly value="<?= $_SESSION['jaccount']['id'] ?>"
			       type="text">
