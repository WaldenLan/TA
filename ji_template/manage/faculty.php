<div id="mmain" class="mmain">
	<h2>教授讲师</h2><a class="maina" href="/manage/faculty_add"><span>添加中文讲师</span></a><a class="maina"
	                                                                                   href="/manage/faculty_en"><span>English</span></a>
	<div class="faculty">
			...
			<table width="1000" border="0" cellpadding="5" cellspacing="1" bgcolor="#D4D4D4">
				<tr>
					<td rowspan="3" align="center" valign="middle" bgcolor="#FFFFFF"><a
								href="/faculty/view/<?= $f->id ?>" target="_blank"><img
					...
					<td width="330" height="30" align="center" valign="middle" bgcolor="#F2F2F2"><a
								...
								{
									echo "alumni";
								} ?>/<?= $f->id ?>"><span>Ｔ</span></a><a href="/manage/faculty_add/<?= $f->id ?>"><span>Add En</span></a>
					</td>
				</tr>
				<tr>
