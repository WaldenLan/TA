		...
		<table width="800" border="0" class="course_add" cellpadding="8" cellspacing="1" bgcolor="#D4D4D4" align="left">
			...
			<tr>
				...
				<td width="330" height="30" bgcolor="#F0F0F0"><label>
						<input class="inputs" type="text" name="code" value="<?= $course['course_code'] ?>"/></label>
				</td>
				
				<td width="70" height="30" align="right" valign="middle" bgcolor="#CFE2FE">JI Subject</td>
				<td width="330" height="30" bgcolor="#CFE2FE">
					<label for="category">
						<input class="inputs" type="text" name="ji_category"
						       value="<?= $course['ji_category'] ?>"/></label>
				</td>
			</tr>
			<tr>
				...
				<td width="330" height="30" bgcolor="#F0F0F0">
					...
					<select name="university" id="university">
						...
						{ ?>
							<option value="<?= $u->university_id ?>" <?php if ($course['university_id'] ==
							                                                   $u->university_id
							)
							{
								echo "selected='selected'";
							} ?>><?= $u->university_name ?></option>
						<?php } ?>
					</select></td>
				<td width="70" height="30" align="right" valign="middle" bgcolor="#CFE2FE">Catalog</td>
				<td width="330" height="30" bgcolor="#CFE2FE"><label>
						<input class="inputs" type="text" name="ji_code" value="<?= $course['ji_code'] ?>"/></label>
				</td>
			</tr>
			<tr>
				...
				<td width="330" height="30" bgcolor="#F0F0F0">
					<label for="credits">
						<input class="inputs" type="text" name="credits"
						       value="<?= $course['course_credits'] ?>"/></label>
				</td>
				<td width="70" height="30" align="right" valign="middle" bgcolor="#CFE2FE">Credits</td>
				<td width="330" height="30" bgcolor="#CFE2FE">
					<label for="ji_credits">
						<input class="inputs" type="text" name="ji_credits"
						       value="<?= $course['ji_credits'] ?>"/></label>
				</td>
			</tr>
			<tr>
				...
				<td width="330" height="30" bgcolor="#F0F0F0"><label for="language"></label>
					<select name="language" id="language">
						<option value="English" <?php if ($course['course_language'] == 'English')
						{
							echo "selected='selected'";
						} ?>>English
						</option>
						<option value="Dual" <?php if ($course['course_language'] == 'Dual')
						{
							echo "selected='selected'";
						} ?>>Dual
						</option>
						<option value="Chinese" <?php if ($course['course_language'] == 'Chinese')
						{
							echo "selected='selected'";
						} ?>>Chinese
						</option>
						<option value="French" <?php if ($course['course_language'] == 'French')
						{
							echo "selected='selected'";
						} ?>>French
						</option>
						
						<option value="German" <?php if ($course['course_language'] == 'German')
						{
							echo "selected='selected'";
						} ?>>German
						</option>
						<option value="Japanese" <?php if ($course['course_language'] == 'Japanese')
						{
							echo "selected='selected'";
						} ?>>Japanese
						</option>
						<option value="Portuguese" <?php if ($course['course_language'] == 'Portuguese')
						{
							echo "selected='selected'";
						} ?>>Portuguese
						</option>
						<option value="Russian" <?php if ($course['course_language'] == 'Russian')
						{
							echo "selected='selected'";
						} ?>>Russian
						</option>
						<option value="Spanish" <?php if ($course['course_language'] == 'Spanish')
						{
							echo "selected='selected'";
						} ?>>Spanish
						</option>
				...
				<td width="330" height="30" bgcolor="#CFE2FE"><label>
						<input class="inputs" type="text" name="ji_remarks"
						       value="<?= $course['ji_remarks'] ?>"/></label></td>
			</tr>
			<tr>
				<td width="70" height="30" align="right" valign="middle" bgcolor="#F0F0F0">部门</td>
				<td width="330" height="30" bgcolor="#F0F0F0">
					<label>
						<input class="inputs" type="text" name="department"
						       value="<?= $course['course_department'] ?>"/></label></td>
			...
			<tr>
				...
				<td width="330" height="30" bgcolor="#F0F0F0">
					<label>
						<input class="inputs" type="text" name="name" value="<?= $course['course_name'] ?>"/></label>
				</td>
				<td width="70" height="30" align="right" valign="middle" bgcolor="#CFE2FE">&nbsp;</td>
				<td width="330" height="30" bgcolor="#CFE2FE"></td>
			</tr>
			...
			<tr>
				...
				<td height="30" colspan="3" bgcolor="#F0F0F0"><label>
						<input type="checkbox" name="top"<?php if ($course['course_top'] == '1')
						{
