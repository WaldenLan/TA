<div id="mmain" class="mmain">
	...
	<form action="config_save_cn" method="post">
		<table width="800" border="0" class="config" cellpadding="8" cellspacing="1" bgcolor="#D4D4D4">
			<tr>
				<td width="120" height="30" align="right" valign="middle" bgcolor="#CFE2FE"><strong>网站名称&nbsp;</strong>
				</td>
			...
			<tr>
				<td width="120" height="30" align="right" valign="middle" bgcolor="#CFE2FE"><strong>网站标题&nbsp;</strong>
				</td>
				<td width="680" height="30" bgcolor="#F0F0F0"><label>
			...
			<tr>
				<td width="120" height="30" align="right" valign="middle" bgcolor="#CFE2FE"><strong>关键词&nbsp;</strong>
				</td>
				<td width="680" height="30" bgcolor="#F0F0F0"><label>
			...
			<tr>
				<td width="120" height="30" align="right" valign="middle" bgcolor="#CFE2FE"><strong>网站描述&nbsp;</strong>
				</td>
				<td width="680" height="30" bgcolor="#F0F0F0"><label>
    ...
    <td width="680" height="30" bgcolor="#F0F0F0"><label>
      <input type="radio" name="en" <?php if ($cn['en'] == 1)
			{ ?>checked="checked" <?php }; ?>value="1" />
    开 
    <input type="radio" name="en" <?php if ($cn['en'] == 0)
	...
	<form action="config_save_en" method="post">
		<table width="800" border="0" class="config" cellpadding="8" cellspacing="1" bgcolor="#D4D4D4">
			<tr>
				<td width="120" height="30" align="right" valign="middle" bgcolor="#CFE2FE"><strong>Site
						Name&nbsp;</strong></td>
				<td width="680" height="30" bgcolor="#F0F0F0"><label>
