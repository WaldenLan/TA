<div id="mmain" class="mmain">
	...
	<form action="config_save_cn" method="post">
		<table width="800" border="0" class="config" cellpadding="8" cellspacing="1" bgcolor="#D4D4D4">
			...
			<?php } ?>
			<tr>
				<td height="30" colspan="2" bgcolor="#F0F0F0" style="line-height:30px;"><b>特殊声明：</b><br/>该系统源码版权归该系统开发者私有，任何人不得在未得到私有者授权情况下将该系统用于商业用途或私自公开源代码。<br/>&copy;小皇博客，2013-2015<br/>获取授权：QQ:525562633，TEL:13916658320
				</td>
			</tr>
		</table>
	</form>
