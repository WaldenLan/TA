...
<?php
//验证用户权限
$permit = $this->db->query("select * from ji_user_permission where user_id='" . $_SESSION['user'] . "' and module='" .
                           $module . "'")->result();
if ($module == 'home')
{
	$permit = 2;
...
{
	echo $_SESSION['user'];
	echo ', you have no permissions to visit this page.';
	die;
}
