	...
	<div id="mmain" class="mmain">
		<h2>Faculty List</h2><a class="maina" href="/manage/faculty_add"><span>添加</span></a><a class="maina" href="/manage/faculty"><span>中文</span></a>
<div class="faculty">
<?php foreach ($faculty as $f): ?>
<table width="1000" border="0" cellpadding="5" cellspacing="1" bgcolor="#D4D4D4">
  <tr>
    <td rowspan="3" align="center" valign="middle" bgcolor="#FFFFFF"><a href="/en/faculty/view/<?=$f->id?>" target="_blank"><img src="/ji_upload/faculty/<?=$f->f_pic?>" width="95" height="110"></a></td>
