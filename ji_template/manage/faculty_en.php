<div id="mmain" class="mmain">
	<h2>Faculty List</h2><a class="maina" href="/manage/faculty_add"><span>添加</span></a><a class="maina"
	                                                                                       href="/manage/faculty"><span>中文</span></a>
	<div class="faculty">
		<?php foreach ($faculty as $f): ?>
			<table width="1000" border="0" cellpadding="5" cellspacing="1" bgcolor="#D4D4D4">
				<tr>
					<td rowspan="3" align="center" valign="middle" bgcolor="#FFFFFF"><a
								href="/en/faculty/view/<?= $f->id ?>" target="_blank"><img
									src="/ji_upload/faculty/<?= $f->f_pic ?>" width="95" height="110"></a></td>
					<td width="100" height="30" align="center" valign="middle" bgcolor="#CFE2FE">姓名</td>
					<td width="330" height="30" valign="middle" bgcolor="#FFFFFF"><span><?= $f->f_name ?>
							(<?php if ($f->f_style == 1)
							{
								echo "教授";
							}
					...
					<td width="330" height="30" align="center" valign="middle" bgcolor="#F2F2F2"><a
								href="/manage/faculty_edit/<?= $f->id ?>"><span>修改</span></a>　　<a
								href="/manage/faculty_del/<?= $f->id ?>"
								onclick="return confirm('是否确认删除？删除后不会显示在后台列表中，但是仍旧存在于数据库中，可找回！')"><span>删除</span></a><a
								href="/manage/tuisong/<?php if ($f->f_style == 1)
								{
									echo "faculty";
								}
								else
								{
									echo "alumni";
								} ?>/<?= $f->id ?>"><span>Ｔ</span></a><a
								href="/manage/faculty_edit/<?= $f->f_en ?>"><span>CN</span></a></td>
				</tr>
				<tr>
