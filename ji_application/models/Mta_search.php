...
class Mta_search extends CI_Model
{
	...
	public function search_ta($keys, $begin = 0, $length = 20)
	{
		...
		$query = $this->db->limit($length, $begin)->order_by('USER_ID', 'ASC')->get();
		$ta_list = array();
	...
	public function search_course($keys, $begin = 0, $length = 20)
	{
