...
function getCourseInfo(currentCourseid) {
    ...
    if ($('.list .application-status .status').text() == "Close") {
        $('.list .application-status .change').css("display","none");
        $('#form_status').val("1");
    }
    else {
        $('.list .application-status .change').attr("value", "Apply");
        $('.list .application-status .change').css("display","block");
        $('#form_status').val("0");
    }

    $('.list .course-information .course_id').text(ucfirst($('#class_data #' + currentCourseid).attr("KCDM")));
    $('.list .course-information .course_title').text($('#class_data #' + currentCourseid).attr("KCZWMC"));
    $('.list .course-information .name').text($('#class_data #' + currentCourseid).attr("XM"));
    $('.list .course-information .semester').text($('#class_data #' + currentCourseid).attr("XQ"));
    $('.list .course-information .year').text($('#class_data #' + currentCourseid).attr("XN"));
    $('.list .course-information .description').text($('#class_data #' + currentCourseid).attr("KCJJ"));
    $('.list .course-information .max').text($('#class_data #' + currentCourseid).attr("maxta"));
    $('.list .course-information .current').text($('#class_data #' + currentCourseid).attr("curta"));
    $('.list .course-information .salary').text($('#class_data #' + currentCourseid).attr("salary"));
    $('.list .course-information .email').text($('#class_data #' + currentCourseid).attr("email"));
...
$(document).ready(function () {
    ...
    $('.list .application-status .change').click(function (event) {
        event.preventDefault();
        location.href = "/ta/application/Student/applydetail?courseid="+currentCourseid;
    });
});